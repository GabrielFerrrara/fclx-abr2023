...
import (
	...
	"github.com/gabrielferrrara/fclx/chatservice/configs"
	"github.com/gabrielferrrara/fclx/chatservice/internal/infra/grpc/server"
	"github.com/gabrielferrrara/fclx/chatservice/internal/infra/repository"
	"github.com/gabrielferrrara/fclx/chatservice/internal/infra/web"
	"github.com/gabrielferrrara/fclx/chatservice/internal/infra/web/webserver"
	"github.com/gabrielferrrara/fclx/chatservice/internal/usecase/chatcompletion"
	"github.com/gabrielferrrara/fclx/chatservice/internal/usecase/chatcompletionstream"
...
func main() {
	...
	webserverCharHendler := web.NewWebChatGPTHandler(*usecase, chatConfig, configs.AuthToken)
	webserver.AddHandler("/chat", webserverCharHendler.Handle)
